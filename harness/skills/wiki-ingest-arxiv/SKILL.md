...
preference in {{SCHEMA}}. Ask it to inventory substantive source content before writing
...
- `wiki/papers/<safe-id>.md` from `templates/paper.md` — the full digest, LaTeX math in
  `$...$`, custom macros expanded. Follow {{SCHEMA}} → Paper explanations and technical
  ...
  propagated to other pages, follow {{SCHEMA}} → Evidence and document verification.

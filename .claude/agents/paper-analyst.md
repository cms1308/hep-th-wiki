...
## Historical context
What prior work it builds on (from its references and standard history), with names and years.

## Main results
Numbered, each a precise claim or conjecture with the key formula(s).

## Methods
Each technique used, with 1-3 sentences on how it's applied here.
